...
import { PiCursorFill, PiRectangle, PiCircle, PiLineSegment, PiArrowUpRight, PiStorefront, PiTextT, PiSticker, PiRuler, PiPaintBrush, PiEraser, PiSquare } from "react-icons/pi";
