...
import { PiCursorFill, PiRectangle, PiCircle, PiLineSegment, PiArrowUpRight, PiBezierCurve, PiStorefront, PiTextT, PiSticker, PiRuler, PiPaintBrush, PiEraser, PiSquare } from "react-icons/pi";
